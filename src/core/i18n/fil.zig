...
pub const strings = Strings{
    ...
    .label_fail = "BIGO",
    .label_info = "IMPO",
    .label_notice = "PAALALA",
    .label_unknown = "HINDI ALAM",
    .label_slow = "MABAGAL",
    .summary_title = "Buod:",
    .summary_interrupted = "Naputol - Bahagyang buod:",
    .summary_valid = "Wasto:",
    .summary_invalid = "Hindi wasto:",
    .summary_unknown = "Hindi alam:",
    .summary_processed = "Naproseso:",
    .depth_structural = "istruktural",
    .depth_full = "ganap na na-validate",
    .scanning_files_found = "Nag-iiskan... %zu na file ang natagpuan",
    .found_files_to_validate = "%zu na file ang iva-validate.",
    .checking = "Sinusuri:",
    .full_validation_unavailable = "Hindi available ang ganap na pag-validate",
    .via_ffmpeg_suffix = "sa pamamagitan ng ffmpeg",
    ...
    .help_entropy_shield = "Pigilan ang pinsala sa mga file sa hinaharap gamit ang Entropy Shield: https://entropyshield.app",
};
...
pub const cli_aliases = cli.CliAliases{
    ...
    .shuffle = "haluin",
    .stress = "stress",
    .no_color = "walang-kulay",
    .color = "kulay",
    .simple_progress = "simpleng-progreso",
    .no_frontload = "walang-prayoridad",
    .append = "append",
    .json = "json",
    .ndjson = "ndjson",
    .about = "about",
...
pub const env_aliases = cli.EnvAliases{
    .ok_out = "OK_LABAS",
    .warn_out = "BABALA_LABAS",
    .fail_out = "BIGO_LABAS",
    .unknown_out = "HINDI_ALAM_LABAS",
    .slow_out = "MABAGAL_LABAS",
    .debug_out = "DEBUG_LABAS",
    .begin_out = "SIMULA_LABAS",
    .max_files = "MAX_FILE",
...
pub const format_descriptions = i18n.FormatDescriptions.init(.{
    ...
    .webp = "WebP Larawan",
    .tiff = "TIFF Larawan",
    .heic = "HEIC/HEIF Larawan",
    .avif = "AVIF Larawan",
    .exr = "OpenEXR HDR Larawan",
    ...
    .pef = "Pentax RAW",
    .zip = "ZIP Archive",
    .gzip = "Gzip na Naka-compress",
    .bzip2 = "Bzip2 na Naka-compress",
    .xz = "XZ na Naka-compress",
    .zstd = "Zstandard na Naka-compress",
        .br = "Brotli na Naka-compress", .hqx = "BinHex 4.0 Archive", .rar = "RAR Archive", .cpt = "Compact Pro Archive",
    ...
    .jpeg2000 = "JPEG2000 Larawan",
    .jbig2 = "JBIG2 Bi-level na Larawan",
    .qoi = "QOI Larawan",
    .pam = "Portable Anymap na Larawan",
    .dpx = "DPX Larawan",
    .tga = "TGA Larawan",
    ...
    .dicom = "DICOM na Larawang Medikal",
    ...
    .kmz = "KMZ na Naka-compress na KML",
    .dxf = "AutoCAD DXF",
    .step = "STEP CAD Model",
    .stl = "STL 3D Model",
    ...
    .rpm = "RPM Package", .gpt_disk_image = "GPT-partitioned disk image", .thumbs_db = "Windows Thumbnail Cache",
});
