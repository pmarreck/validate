...
pub const format_descriptions = i18n.FormatDescriptions.init(.{
    ...
    .ar = "Unix ar Archive",
    .html = "HTML Document",
    .x12_edi = "X12 EDI Document",
    .edifact = "UN/EDIFACT Document",
    ...
    .rpm = "RPM Package", .gpt_disk_image = "GPT-partitioned disk image", .thumbs_db = "Windows Thumbnail Cache (Thumbs.db)",
});
