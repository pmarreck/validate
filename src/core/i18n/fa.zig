...
pub const strings = Strings{
    // CLI status labels
    .label_ok = "OK",
    .label_warn = "\xd9\x87\xd8\xb4\xd8\xaf\xd8\xa7\xd8\xb1",
    .label_fail = "\xd8\xae\xd8\xb7\xd8\xa7",
    .label_notice = "\xd8\xa7\xd8\xb7\xd9\x84\xd8\xa7\xd8\xb9\xd9\x8a\xd9\x87",
    .label_unknown = "\xd9\x86\xd8\xa7\xd8\xb4\xd9\x86\xd8\xa7\xd8\xae\xd8\xaa\xd9\x87",
    .label_slow = "\xd9\x83\xd9\x86\xd8\xaf",

    // Summary
    .summary_title = "\xd8\xae\xd9\x84\xd8\xa7\xd8\xb5\xd9\x87:",
    .summary_interrupted = "\xd9\x82\xd8\xb7\xd8\xb9 \xd8\xb4\xd8\xaf - \xd8\xae\xd9\x84\xd8\xa7\xd8\xb5\xd9\x87 \xd8\xac\xd8\xb2\xd8\xa6\xd9\x8a:",
    .summary_valid = "\xd9\x85\xd8\xb9\xd8\xaa\xd8\xa8\xd8\xb1:",
    .summary_invalid = "\xd9\x86\xd8\xa7\xd9\x85\xd8\xb9\xd8\xaa\xd8\xa8\xd8\xb1:",
    .summary_unknown = "\xd9\x86\xd8\xa7\xd8\xb4\xd9\x86\xd8\xa7\xd8\xae\xd8\xaa\xd9\x87:",
    .summary_processed = "\xd9\xbe\xd8\xb1\xd8\xaf\xd8\xa7\xd8\xb2\xd8\xb4 \xd8\xb4\xd8\xaf\xd9\x87:",

    // Depth descriptions
    .depth_structural = "\xd8\xb3\xd8\xa7\xd8\xae\xd8\xaa\xd8\xa7\xd8\xb1\xd9\x8a",
    .depth_full = "\xd8\xa8\xd9\x87 \xd8\xb7\xd9\x88\xd8\xb1 \xd9\x83\xd8\xa7\xd9\x85\xd9\x84 \xd8\xaa\xd8\xa3\xd9\x8a\xd9\x8a\xd8\xaf \xd8\xb4\xd8\xaf\xd9\x87",

    // Progress / startup
    .scanning_files_found = "\xd8\xaf\xd8\xb1 \xd8\xad\xd8\xa7\xd9\x84 \xd8\xa7\xd8\xb3\xd9\x83\xd9\x86... %zu \xd9\x81\xd8\xa7\xd9\x8a\xd9\x84 \xd9\x8a\xd8\xa7\xd9\x81\xd8\xaa \xd8\xb4\xd8\xaf",
    .found_files_to_validate = "%zu \xd9\x81\xd8\xa7\xd9\x8a\xd9\x84 \xd8\xa8\xd8\xb1\xd8\xa7\xd9\x8a \xd8\xaa\xd8\xa3\xd9\x8a\xd9\x8a\xd8\xaf.",
    .checking = "\xd8\xa8\xd8\xb1\xd8\xb1\xd8\xb3\xd9\x8a:",

    // Misc
    .full_validation_unavailable = "\xd8\xaa\xd8\xa3\xd9\x8a\xd9\x8a\xd8\xaf \xd9\x83\xd8\xa7\xd9\x85\xd9\x84 \xd8\xaf\xd8\xb1 \xd8\xaf\xd8\xb3\xd8\xaa\xd8\xb1\xd8\xb3 \xd9\x86\xd9\x8a\xd8\xb3\xd8\xaa",
    .via_ffmpeg_suffix = "\xd8\xa7\xd8\xb2 \xd8\xb7\xd8\xb1\xd9\x8a\xd9\x82 ffmpeg",
    ...
    .help_entropy_shield = "از خرابی آینده فایل‌ها با Entropy Shield جلوگیری کنید: https://entropyshield.app",
};

pub const cli_aliases = cli.CliAliases{
    .help = "\xda\xa9\xd9\x85\xda\xa9",
    .version = "\xd9\x86\xd8\xb3\xd8\xae\xd9\x87",
    .lang = "\xd8\xb2\xd8\xa8\xd8\xa7\xd9\x86",
    .jobs = "\xda\xa9\xd8\xa7\xd8\xb1\xd9\x87\xd8\xa7",
    .shuffle = "\xd8\xa8\xd8\xb1\xd8\xb2\xd8\xaf\xd9\x86",
    .stress = "stress",
    .no_color = "\xd8\xa8\xd8\xaf\xd9\x88\xd9\x86-\xd8\xb1\xd9\x86\xda\xaf",
    .color = "\xd8\xb1\xd9\x86\xda\xaf",
    .simple_progress = "\xd9\xbe\xd9\x8a\xd8\xb4\xd8\xb1\xd9\x81\xd8\xaa-\xd8\xb3\xd8\xa7\xd8\xaf\xd9\x87",
    .no_frontload = "\xd8\xa8\xd8\xaf\xd9\x88\xd9\x86-\xd8\xa7\xd9\x88\xd9\x84\xd9\x88\xd9\x8a\xd8\xaa",
};

pub const env_aliases = cli.EnvAliases{
    .ok_out = "MOVAFFAQ_KHOROOJI",
    .warn_out = "HOSHDAR_KHOROOJI",
    .fail_out = "SHEKAST_KHOROOJI",
    .unknown_out = "NASHENAKHTE_KHOROOJI",
    .slow_out = "KOND_KHOROOJI",
    .debug_out = "DEBUG_KHOROOJI",
    .begin_out = "SHOROU_KHOROOJI",
    .max_files = "BISHINE_FAYLHA",
