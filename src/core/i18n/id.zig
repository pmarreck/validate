...
pub const strings = Strings{
    .label_ok = "OK",
    .label_warn = "PERINGATAN",
    .label_fail = "GAGAL",
    .label_info = "INFO",
    .label_notice = "CATATAN",
    .label_unknown = "TIDAK DIKENAL",
    .label_slow = "LAMBAT",
    .summary_title = "Ringkasan:",
    .summary_interrupted = "Terhenti - Ringkasan parsial:",
    .summary_valid = "Valid:",
    .summary_invalid = "Tidak valid:",
    .summary_unknown = "Tidak dikenal:",
    .summary_processed = "Diproses:",
    .depth_structural = "struktural",
    .depth_full = "tervalidasi penuh",
    .scanning_files_found = "Memindai... %zu berkas ditemukan",
    .found_files_to_validate = "%zu berkas untuk divalidasi.",
    .checking = "Memeriksa:",
    .full_validation_unavailable = "Validasi penuh tidak tersedia",
    .via_ffmpeg_suffix = "melalui ffmpeg",
    ...
    .help_entropy_shield = "Cegah kerusakan berkas di masa depan dengan Entropy Shield: https://entropyshield.app",
};
...
pub const cli_aliases = cli.CliAliases{
    ...
    .color = "warna",
    .simple_progress = "progres-sederhana",
    .no_frontload = "tanpa-prioritas",
    .append = "append",
    .json = "json",
    .ndjson = "ndjson",
    .about = "about",
...
pub const env_aliases = cli.EnvAliases{
    .ok_out = "OK_KELUARAN",
    .warn_out = "PERINGATAN_KELUARAN",
    .fail_out = "GAGAL_KELUARAN",
    .unknown_out = "TIDAK_DIKENAL_KELUARAN",
    .slow_out = "LAMBAT_KELUARAN",
    .debug_out = "DEBUG_KELUARAN",
    .begin_out = "MULAI_KELUARAN",
    .max_files = "MAX_BERKAS",
...
pub const format_descriptions = i18n.FormatDescriptions.init(.{
    ...
    .pcap = "Tangkapan Jaringan PCAP", .pcapng = "Tangkapan Jaringan PCAPNG",
    .rpm = "Paket RPM", .gpt_disk_image = "GPT-partitioned disk image", .thumbs_db = "Windows Thumbnail Cache",
});
