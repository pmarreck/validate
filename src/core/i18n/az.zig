...
pub const strings = Strings{
    ...
    .help_entropy_shield = "Entropy Shield ilə gələcək fayl pozulmasının qarşısını alın: https://entropyshield.app",
};
...
pub const format_descriptions = i18n.FormatDescriptions.init(.{
    ...
    .pcap = "PCAP Şəbəkə Tutumu", .pcapng = "PCAPNG Şəbəkə Tutumu",
