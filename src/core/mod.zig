...
pub const dir_walker = @import("dir_walker.zig");
...
pub const spotlight_ivf = @import("spotlight_ivf.zig");
pub const spotlight_store = @import("spotlight_store.zig");
...
test {
    ...
    _ = @import("spotlight_ivf.zig");
    _ = @import("spotlight_store.zig");
