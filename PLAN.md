...
## Recently Completed
- [x] Route UNKNOWN entries via UNKNOWN_OUT and add CLI tests (2026-01-26 19:20 EST)
- [x] Add byte-coverage parsers for H.264/HEVC/AV1 across MP4/MKV/AVI (2026-01-26 19:20 EST)
