...
| `src/core/financial_validators.zig` | QBW (QuickBooks Company File, SQL Anywhere + legacy MAUI), QBB (QuickBooks Backup, OLE2), QDF (Quicken Data File, OLE2/ZIP/legacy), OFX (Open Financial Exchange, SGML/XML), QIF (Quicken Interchange Format, text), TXF (Tax Exchange Format, text) |
