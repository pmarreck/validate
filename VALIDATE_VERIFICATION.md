...
- **Total Formats**: 125+
- **With Ground Truth**: 38 formats tested
- **Verified Valid**: 37
- **Verified Corrupt Detection**: 37 (185 corruption tests passed)
- **Needs Inquiry**: 0
- **Missing Examples**: 87+

### Tested Formats (37 passing all checks)

**Images (10):** png, jpeg, jxl, gif, bmp, webp, tiff, heic, avif, jpeg2000

**Audio (10):** mp3, flac, wav, ogg, wavpack, midi, ac3, eac3, alac

**Trackers (4):** mod, xm, it, s3m

**Video (8):** mp4, mov (prores), mkv, webm, avi, prores, ogv

**Archives (5):** zip, brotli, rar, par2

**Documents (3):** pdf, xls, ppt
...
*Generated by scripts/corruption_test.sh*
